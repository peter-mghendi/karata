...
namespace Karata.Cards.Data.Migrations
{
    ...
    [Migration("20250706171639_AddAdministratorToRoom")]
    partial class AddAdministratorToRoom
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Karata.Cards.Models.Turn", b =>
                {
                    b.HasOne("Karata.Cards.Models.Hand", null)
                        .WithMany("Turns")
                        .HasForeignKey("HandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("Karata.Cards.Models.GameDelta", "Delta", b1 =>
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Karata.Cards.Models.User", null)
                        .WithMany()
